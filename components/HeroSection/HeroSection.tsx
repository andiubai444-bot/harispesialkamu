...
interface HeroSectionProps {
  startTyping?: boolean; // true = mulai ngetik
}

export default function HeroSection({ startTyping = false }: HeroSectionProps) {
  ...
  // Mulai ngetik hanya ketika startTyping = true
  useEffect(() => {
      ...
      <div className="relative w-full max-w-6xl mx-auto pt-16 pb-24">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-8 sm:gap-0">
          ...
          <div className="flex-1 flex justify-center sm:justify-end relative animate-float-slow">
            <div className="absolute -top-8 left-1/2 sm:left-auto sm:-left-10 -translate-x-1/2 sm:translate-x-0 z-20 pointer-events-none select-none whitespace-nowrap">
              <span
            ...
            <div className="relative mt-6" style={{ transform: "rotate(2.5deg)" }}>
              <div className="pointer-events-none absolute -inset-5 rounded-[2.75rem] bg-pink-200/50 blur-2xl" aria-hidden="true" />
